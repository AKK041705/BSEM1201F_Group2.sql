...
-- INSERT SAMPLE DATA — APPOINTMENTS (20 records)
INSERT INTO Appointment (Visit_Date, Visit_Reason, Patient_ID, Health_Worker_ID)
VALUES
('2026-02-01', 'Fever and headache',          1,  1),
...
--UPDATE & DELETE EXAMPLES — APPOINTMENT
--UPDATE 
UPDATE Appointment
...
--INSERT SAMPLE DATA — MEDICAL_DIAGNOSIS (20 records)
...
-- UPDATE & DELETE EXAMPLES — MEDICAL_DIAGNOSIS
...
-- INSERT SAMPLE DATA — TREATMENT (20 records)
...
-- UPDATE & DELETE EXAMPLES — TREATMENT
...
SELECT MIN(Treatment_Cost) AS Lowest_Cost_Per_Medicine, Medicine_Name
FROM Treatment
GROUP BY Medicine_Name
